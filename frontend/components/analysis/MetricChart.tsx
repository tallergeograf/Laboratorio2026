...
export function MetricChart({ label, description, unit, values, fullWidth, yMax }: MetricChartProps) {
  return (
    <Card className={`bg-[#1a1a1a] border-white/10 ${fullWidth ? 'col-span-2' : ''}`}>
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={values}>
            ...
            <YAxis
              ...
              tickFormatter={yMax ? (v) => `${v}%` : undefined}
            />
            <Tooltip
