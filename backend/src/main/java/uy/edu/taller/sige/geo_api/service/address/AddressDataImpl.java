...
public class AddressDataImpl implements AddressDataService {
    ...
    public List<String> processAddress() {
        ...
        generateAndSaveAbbreviations(
                accuracyAddress,
                AddressCategory.CALLE_NUMERO,
                a -> StreetAbbreviator.abbreviate(a.getNombreVia()) + " " + a.getNumPuerta()
        );
        ...
        generateAndSaveAbbreviations(
                streetNumberLocality,
                AddressCategory.CALLE_NUMERO_LOCALIDAD,
                a -> StreetAbbreviator.abbreviate(a.getNombreVia()) + " " + a.getNumPuerta() + "," + a.getLocalidad()
        );
        ...
        generateAndSaveErrors(
                ...
                AddressCategory.CALLE_NUMERO_LOCALIDAD,
                a -> a.getNombreVia(),
                a -> " " + a.getNumPuerta() + "," + a.getLocalidad()
        );
        ...
        generateAndSaveAbbreviations(
                streetNumberDepartament,
                AddressCategory.CALLE_NUMERO_DEPARTAMENTO,
                a -> StreetAbbreviator.abbreviate(a.getNombreVia()) + " " + a.getNumPuerta() + "," + a.getDepartamento()
        );
        ...
        generateAndSaveErrors(
                ...
                AddressCategory.CALLE_NUMERO_DEPARTAMENTO,
                a -> a.getNombreVia(),
                a -> " " + a.getNumPuerta() + "," + a.getDepartamento()
        );
        ...
        generateAndSaveAbbreviations(
                streetNumberlocalityDepartament,
                AddressCategory.CALLE_NUMERO_LOCALIDAD_DEPARTAMENTO,
                a -> StreetAbbreviator.abbreviate(a.getNombreVia()) + " " + a.getNumPuerta() + "," + a.getLocalidad() + "," + a.getDepartamento()
        );
        ...
        generateAndSaveErrors(
                ...
                AddressCategory.CALLE_NUMERO_LOCALIDAD_DEPARTAMENTO,
                a -> a.getNombreVia(),
                a -> " " + a.getNumPuerta() + "," + a.getLocalidad() + "," + a.getDepartamento()
        );
    ...
    */
    ...
    private void generateAndSave(
        ...
        List<SpecificAddress> addresses = toSpecificAddresses(source, category, type, addressBuilder);
